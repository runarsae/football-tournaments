...
public class FtPackageImpl extends EPackageImpl implements FtPackage {
	...
	public void initializePackageContents() {
		...
		initEReference(getSeason_Stages(), this.getStage(), this.getStage_Season(), "stages", null, 1, -1, Season.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getTable_Stage(), this.getDoubleRoundRobin(), null, "stage", null, 1, 1, Table.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		addEEnumLiteral(genderKindEEnum, GenderKind.MEN);
		addEEnumLiteral(genderKindEEnum, GenderKind.WOMEN);
	...
	protected void createEcoreAnnotations() {
		...
		addAnnotation
		  (stageEClass,
		   source,
		   new String[] {
			   "constraints", "clubsMustBeInSeason roundNumbersMustBeUnique"
		   });
		addAnnotation
	...
	protected void create_1Annotations() {
		...
		addAnnotation
		  (stageEClass,
		   source,
		   new String[] {
			   "clubsMustBeInSeason", "self.season.clubs->includesAll(self.clubs)",
		...
		addAnnotation
		  (doubleRoundRobinEClass,
		   ...
		   new String[] {
			   ...
			   "everyClubMustMeetEveryOtherClubHomeAndAway", "self.clubs->collect(club1 | self.clubs->select(club2 | club1 <> club2)->collect(club2  | self.rounds->collect(round | round.matches)->exists(match | match.homeClub = club1 and match.awayClub = club2)))->forAll(v | v)",
