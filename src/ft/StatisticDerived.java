...
/**
 * <!-- begin-user-doc -->
 * A representation of the model object '<em><b>Statistic Derived</b></em>'.
 * <!-- end-user-doc -->
 *
 * <p>
 ...
 * </p>
 * <ul>
 *   <li>{@link ft.StatisticDerived#getClub <em>Club</em>}</li>
 *   <li>{@link ft.StatisticDerived#getPosition <em>Position</em>}</li>
 *   <li>{@link ft.StatisticDerived#getPlayed <em>Played</em>}</li>
 *   <li>{@link ft.StatisticDerived#getWon <em>Won</em>}</li>
 *   <li>{@link ft.StatisticDerived#getDrawn <em>Drawn</em>}</li>
 *   <li>{@link ft.StatisticDerived#getLost <em>Lost</em>}</li>
 *   <li>{@link ft.StatisticDerived#getGoalsFor <em>Goals For</em>}</li>
 *   <li>{@link ft.StatisticDerived#getGoalsAgainst <em>Goals Against</em>}</li>
 *   <li>{@link ft.StatisticDerived#getGoalDifference <em>Goal Difference</em>}</li>
 *   <li>{@link ft.StatisticDerived#getPoints <em>Points</em>}</li>
 *   <li>{@link ft.StatisticDerived#getForm <em>Form</em>}</li>
 * </ul>
 *
 * @see ft.FtPackage#getStatisticDerived()
 ...
 * @generated
 */
public interface StatisticDerived extends EObject {
	/**
	 ...
	 * @see #setClub(Club)
	 * @see ft.FtPackage#getStatisticDerived_Club()
	...
	/**
	 * Sets the value of the '{@link ft.StatisticDerived#getClub <em>Club</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see ft.FtPackage#getStatisticDerived_Position()
	 ...
	 * @see ft.FtPackage#getStatisticDerived_Played()
	 * @model transient="true" changeable="false" volatile="true" derived="true"
	 * @generated
	 */
	int getPlayed();
	 ...
	 * @see ft.FtPackage#getStatisticDerived_Won()
	 * @model transient="true" changeable="false" volatile="true" derived="true"
	 * @generated
	 */
	int getWon();
	 ...
	 * @see ft.FtPackage#getStatisticDerived_Drawn()
	 * @model transient="true" changeable="false" volatile="true" derived="true"
	 * @generated
	 */
	int getDrawn();
	 ...
	 * @see ft.FtPackage#getStatisticDerived_Lost()
	 * @model transient="true" changeable="false" volatile="true" derived="true"
	 * @generated
	 */
	int getLost();
	 ...
	 * @see ft.FtPackage#getStatisticDerived_GoalsFor()
	 * @model transient="true" changeable="false" volatile="true" derived="true"
	 * @generated
	 */
	int getGoalsFor();
	 ...
	 * @see ft.FtPackage#getStatisticDerived_GoalsAgainst()
	 * @model transient="true" changeable="false" volatile="true" derived="true"
	 * @generated
	 */
	int getGoalsAgainst();
	 ...
	 * @see ft.FtPackage#getStatisticDerived_GoalDifference()
	 * @model transient="true" changeable="false" volatile="true" derived="true"
	 * @generated
	 */
	 ...
	 * @see ft.FtPackage#getStatisticDerived_Points()
	 * @model transient="true" changeable="false" volatile="true" derived="true"
	 * @generated
	 */
	int getPoints();
	 ...
	 * @see ft.ResultKind
	 * @see ft.FtPackage#getStatisticDerived_Form()
