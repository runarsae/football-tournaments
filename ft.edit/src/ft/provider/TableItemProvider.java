...
/**
 * This is the item provider adapter for a {@link ft.Table} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TableItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Table_stage_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Table_stage_feature", "_UI_Table_type"),
				 FtPackage.Literals.TABLE__STAGE,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(FtPackage.Literals.TABLE__STATISTICS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(FtPackage.Literals.TABLE__STATISTICS,
				 FtFactory.eINSTANCE.createStatistic()));
	}
