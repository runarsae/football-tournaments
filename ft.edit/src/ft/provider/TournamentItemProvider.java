...
/**
 * This is the item provider adapter for a {@link ft.Tournament} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TournamentItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 FtPackage.Literals.TOURNAMENT__NAME,
				 true,
				 false,
				 false,
	...
	protected void addGenderPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Tournament_gender_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Tournament_gender_feature", "_UI_Tournament_type"),
				 FtPackage.Literals.TOURNAMENT__GENDER,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(FtPackage.Literals.TOURNAMENT__SEASONS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(FtPackage.Literals.TOURNAMENT__SEASONS,
				 FtFactory.eINSTANCE.createSeason()));
	}
